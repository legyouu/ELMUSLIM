...
sudo_users = {SUDO,1236115319,1180682052,1831228999,1936946115,1124610301}   
...
send(msg.chat_id_, msg.id_,' 🕊 اصدار سورس مسلم{ S:12✓}')
end
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🕊 الـعـضو   ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'UU_Le2')..') \n 🕊 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 🕊 الـعـضو  : {["..data.first_name_.."](T.ME/UU_Le2)}\n 🕊 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
[↝ 𝐛𝐚𝐭𝐨𝐭](t.me/ba_to_t)
[↝ 𝐡𝐚𝐦𝐨](t.me/H_1_0O)
[↝ 𝐚𝐬𝐚𝐥𝐢𝐲𝐚](http://t.me/AsaliyaEgypt)
...
if text == 'قناه الاستوري' or text == 'استوري المسلم' or text == 'قناه الاستوريهات' or text == 'استوري ليجاند' then 
local Text = [[ 
...
local Text = [[
 🕊 اهلا بك في سورس مسلم الجمدان
 لو عايز بوت بأسعار منسبه وبوت مميز كلمني 🕊 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹B A T O T˼', url="t.me/ba_to_t"},{text = '˹H A M O˼', url="t.me/H_1_0O"}},
{{text = '˹A S A L I Y A˼',url="t.me/AsaliyaEgypt"},{text = '˹M U S L I M ˼', url="t.me/S_31_m"}},
...
if text == 'قناه السورس' or text == 'قناة السورس' or text == '◤━───━𝑬𝑳𝑴𝑼𝑺𝑳𝑰𝑴━───━◥' then
local Text = [[
لقناة سورس مسلم
اتبع الزر إلى تحت ↓
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/UU_Le2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
send(msg.chat_id_, msg.id_, '🕊  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'UU_Le2')..') \n🕊 تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'UU_Le2')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🕊  مـن قبـل  ↚ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'UU_Le2')..') \n 🕊 تـم قفـل التاك بالكتم ')
end,nil)   
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🕊 الـعـضو   ↚ ['..result.title_..'](t.me/'..(text1[3] or 'UU_Le2')..')'..'\n 🕊 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☘️ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_Le2')..') '
...
end --الكود حصري سورس مسلميعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'مسلم').." الاحصائيات" or text == 'الاحصائيات' then  
if Sudo(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' 🕊 الاحصائيات  \n'..' 🕊 عدد الجروبات  ↚ {'..Groups..'}'..'\n 🕊  عدد المشتركين  ↚ {'..Users..'}'
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المبرمج مسلم نن عيني 🥺🤍](t.me/UU_Le2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
if tonumber(msg.sender_user_id_) == tonumber(1831228999) then
if text == 'انا مين' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المالك بطوط نن عيني 🥺🤍](t.me/UU_Le2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🕊', url="http://t.me/"..sudos.UserName},
...
if tonumber(msg.sender_user_id_) == tonumber(1180682052) then
if text == 'انا مين' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور حمو نن عيني 🥺🤍](t.me/UU_Le2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🕊', url="http://t.me/"..sudos.UserName},
...
if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[عضو قميل 🌝💙](t.me/UU_Le2)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تم قفل التعريص بنجاح 😹😎](t.me/UU_Le2)') 
return false
end
end
end
...
{
{text = '𓆩𝑬𝑳𝑴𝑼𝑺𝑳𝑰𝑴𓆪', url="t.me/UU_Le2"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
