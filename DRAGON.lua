...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/legyouu/leil/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1236115319,1491711183,1900794631,1847624105,99990000999}   
...
os.execute('wget https://raw.githubusercontent.com/legyouu/leil/main/DRAGON.lua')
...
if text == 'المطور لوسيفر' or text == 'لوسيفر' or text == 'الخول' then
local Text = [[
[المطور لوسيفر لو حبب تتواصل معاه اتبع الزر اللي تحت](t.me/L_o_s_e_f_i_r)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/legyouu/leil/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/legyouu/leil/main/File_Bot/"..file)
if res == 200 then
