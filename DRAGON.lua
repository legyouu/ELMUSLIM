...
if text == "معلومات ليجاند" and SudoBot(msg) or text == 'انا هنا يبن المره يخول' and SudoBot(msg) then 
if not DevSoFi(msg) then
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/UU_Le2)')
return false
end
